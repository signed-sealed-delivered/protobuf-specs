...
module Sigstore
  module Rekor
    module V1
      ...
      AdditionalSignedEntryTimestamp = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("dev.sigstore.rekor.v1.AdditionalSignedEntryTimestamp").msgclass
