...
module Sigstore
  module TrustRoot
    module V1
      ...
      MTCSigningAuthority = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("dev.sigstore.trustroot.v1.MTCSigningAuthority").msgclass
